...
export const metadata: Metadata = {
  title: "Contact Coastline Solutions",
  description:
      ...
      <section className="bg-white">
        <div className="container-x section grid gap-10 lg:grid-cols-12">
          <div className="lg:col-span-5">
            <div className="rounded-2xl bg-sand p-6 sm:p-8">
              ...
              <a
                ...
                target="_blank"
                rel="noopener"
                className="mt-6 inline-flex items-center gap-2 text-sm font-semibold text-navy hover:text-coast"
              >
          ...
          <div className="lg:col-span-7">
            <div className="rounded-2xl bg-white p-6 shadow-soft ring-1 ring-navy/5 sm:p-8">
