...
export default function ServiceCard({ service }: { service: Service }) {
  return (
    <article className="card flex h-full flex-col p-7">
      ...
      <p className="mt-2 text-cream/75">{service.short}</p>
      <p className="mt-2 text-sm text-cream/60">{service.blurb}</p>
      <ul className="mt-5 grid grid-cols-1 gap-1.5 text-sm text-cream/80 sm:grid-cols-2">
